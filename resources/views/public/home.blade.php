...
<section id="el-club" class="relative w-full py-14 sm:pt-20 overflow-hidden md:mt-0">
  ...
  <div class="absolute inset-0 lg:hidden pointer-events-none">
    <img
      src="{{ Vite::asset('resources/img/home/elclub_placeholder.webp') }}"
      alt=""
      class="h-full w-full object-cover opacity-35 mix-blend-multiply"
    >
    <div class="absolute inset-0 bg-gradient-to-l from-black/85 via-black/50 to-transparent"></div>
  </div>
  ...
  <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
    <div class="grid gap-10 lg:grid-cols-2 lg:gap-14 items-center">
      ...
      <div class="hidden lg:block relative">
        ...
        <div class="pointer-events-none absolute inset-0 bg-gradient-to-l from-black/80 via-black/30 to-transparent"></div>
      </div>
      ...
      <div class="relative z-10 flex flex-col items-end text-right">
        ...
        <p class="mt-6 max-w-xl text-base sm:text-lg text-main leading-relaxed">
          Nuestro club nació en <strong class="text-white font-bold">2003</strong> como un espacio abierto a varias
          <strong class="text-white font-bold">artes marciales</strong>, con entrenos cruzados y competición en
          <strong class="text-white font-bold">judo, sambo, jiu jitsu, grappling y MMA</strong>.
          Tras la <strong class="text-white font-bold">pandemia</strong> nos reorganizamos y ahora formamos parte de la
          <strong class="text-white font-bold">Federación Catalana de Lucha</strong>.
          Los más pequeños siguen un <strong class="text-white font-bold">sistema seguro</strong> que combina técnicas de
          todos nuestros estilos; los adultos entrenan lucha <strong class="text-white font-bold">sambo</strong>,
          <strong class="text-white font-bold">combat sambo</strong> y <strong class="text-white font-bold">MMA</strong>.
        </p>
...
<section id="faq" class="relative w-full sm:pt-10">
  <div class="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
    ...
    @php
      $faqs = [
        ['q' => '¿Hace falta tener experiencia previa para apuntarse?', 'a' => 'No. Puedes empezar desde cero. Adaptamos el entrenamiento a tu nivel y progresas paso a paso.'],
        ['q' => '¿Qué disciplinas se practican en el club?', 'a' => 'Principalmente MMA y Sambo. En función del grupo también trabajamos lucha, grappling y fundamentos de combate.'],
        ['q' => '¿Cómo funcionan las cuotas?', 'a' => 'Tienes planes mensuales y por temporada. La cuota te cubre el periodo pagado y se tiene que volver a pagar al finalizar el periodo.'],
        ['q' => '¿Las clases son siempre en los mismos horarios?', 'a' => 'Normalmente sí, con un patrón semanal. Si hay cambios puntuales se avisan y se actualiza el calendario a través del grupo de WhatsApp.'],
        ['q' => '¿Cómo puedo apuntarme o pedir información?', 'a' => 'Puedes hacer la preinscripción online o contactar con nosotros por Instagram o WhatsApp. Te respondemos rápido.'],
      ];
    @endphp
      ...
      <div class="px-5 sm:px-20 py-6 sm:py-10">
        ...
        @foreach($faqs as $i => $f)
          <div class="py-5 sm:py-6 {{ $i < count($faqs)-1 ? 'border-b border-dotted border-white/25' : '' }}">
            <button type="button"
                    class="w-full flex items-center justify-between gap-6 text-left"
    ...
    <div class="mt-14 flex mx-auto justify-center items-center gap-10">
      ...
      <div class="flex items-center gap-6">
        ...
        <a href="https://www.tiktok.com/@novaunioteam"
          ...
          <svg fill="currentColor" width="20" height="20" viewBox="-3.2 -3.2 38.40 38.40" xmlns="http://www.w3.org/2000/svg">
